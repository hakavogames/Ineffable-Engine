...
public class MenuGameMode implements GameMode {
    ...
    public class IntroBehaviour extends GameComponent {
        ...
        public void start() {
            ...
            queue.addLast(new IntroTitle("Hakavo Games\n     presents",5,7.5f,0.25f,1,1,1));
            queue.addLast(new IntroTitle("A game powered by\n  Ineffable Engine",3.5f,5f,0.25f,1f,1f,1f));
            queue.addLast(new IntroTitle("An engine which is too great to be expressed in words",4,2.5f,0.15f,0.4f,0.4f,0.4f));
            ...
            textRenderer.font=GameServices.getFonts().get("pixeltype");
